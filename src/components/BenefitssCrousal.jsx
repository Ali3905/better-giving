...
const BenefitssCrousal = ({ path, slides }) => {
  ...
  return (
    <div className="lg:flex justify-between w-full items-center p-16 pb-0  hidden relative">
      ...
      <div className='absolute bottom-[-70px] right-[150px] flex flex-col items-center -rotate-[25deg]'>
